...
public class RobotMap {
    ...
    public static int CLIMBER_MOTOR_2=8;
   
    public static int SHOOTER_MOTOR=3;
   
    public static int FEEDER_MOTOR_LEFT=4;
    public static int FEEDER_MOTOR_RIGHT=5;
    
    public static int INTAKE_MOTOR_EXTENDING=6;
    public static int INTAKE_MOTOR_INTAKING=7;
